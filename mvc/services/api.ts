...
export function getApiBaseUrl(): string {
	...
	const VPS_TUNNEL_URL = process.env.EXPO_PUBLIC_VPS_API_URL || 'https://amplifier-analysis-produces-carry.trycloudflare.com';
	...
	const VPS_API_URL = (!__DEV__ && isWeb && VPS_TUNNEL_URL.startsWith('https://'))
		? VPS_TUNNEL_URL 
		: VPS_DIRECT_IP;
