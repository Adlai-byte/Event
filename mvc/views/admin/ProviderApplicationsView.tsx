...
export const ProviderApplicationsView: React.FC<ProviderApplicationsProps> = ({
  user,
  onNavigate,
  onLogout,
}) => {
  ...
  const responsiveStyles = useMemo(
    () => getResponsiveStyles(isMobile, screenWidth),
  ...
  const handleConfirmReject = async () => {
    ...
    try {
      ...
      if (data.ok) {
        ...
        if (__DEV__) console.error('Rejection failed:', data.error);
        setProcessingId(null);
        setRejectApplicationId(null);
        ...
        <View style={responsiveStyles.filterContainer}>
          {(['all', 'pending', 'approved', 'rejected'] as const).map((status) => (
            ...
            >
              <Text
                style={[
                  responsiveStyles.filterTabText,
          ...
          >
            <View style={responsiveStyles.tableContainer}>
              ...
              <View style={responsiveStyles.tableHeader}>
                <Text style={[responsiveStyles.tableHeaderText, responsiveStyles.tableColName]}>
                  Name
                </Text>
                <Text style={[responsiveStyles.tableHeaderText, responsiveStyles.tableColEmail]}>
                  Email
                </Text>
                <Text style={[responsiveStyles.tableHeaderText, responsiveStyles.tableColStatus]}>
                  Status
                </Text>
                <Text style={[responsiveStyles.tableHeaderText, responsiveStyles.tableColDate]}>
                  Applied Date
                </Text>
                <Text style={[responsiveStyles.tableHeaderText, responsiveStyles.tableColActions]}>
                  Actions
                </Text>
              </View>
              ...
              {filteredApplications.map((app, i) => (
                <View
                  key={app.id}
                  style={[responsiveStyles.tableRow, i % 2 === 1 && styles.tableRowAlt]}
                >
                  ...
                  <View style={responsiveStyles.tableColEmail}>
                    <Text style={responsiveStyles.tableCell} numberOfLines={1}>
                      {app.email}
                    </Text>
                  </View>
