...
import { getCategoryIcon, getCategoryLabel, formatPrice, groupByProvider } from '../../utils/serviceHelpers';
      ...
      {isSearching && searchResults.length === 0 && providerResults.length === 0 ? (
        ...
        <ScrollView style={styles.searchResultsScroll}>
          ...
          {searchResults.length > 0 ? (
            <>
              {Object.entries(groupByProvider(searchResults)).map(([providerKey, providerServices]) => {
