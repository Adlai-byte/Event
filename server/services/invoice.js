...
async function generateInvoicePDF(invoiceData) {
    return new Promise((resolve, reject) => {
        try {
            ...
            doc.rect(300, totalY, 250, 80)
               .fill('#F8FAFC')
               .stroke('#E2E8F0');
            
            const subtotal = invoiceData.booking.totalCost;
            ...
            doc.font('Helvetica')
               .fontSize(10)
               .fillColor('#374151')
               .text('Subtotal:', 320, totalY + 10)
               .text('Tax:', 320, totalY + 30)
               .font('Helvetica-Bold')
               .text('Total:', 320, totalY + 50);
            
            doc.text(`₱${subtotal.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`, 450, totalY + 10, { align: 'right' })
               .text(`₱${tax.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`, 450, totalY + 30, { align: 'right' })
               .fontSize(12)
               .text(`₱${total.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`, 450, totalY + 50, { align: 'right' });
